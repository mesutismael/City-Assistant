...
public class MaterialDialog extends DialogBase implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected MaterialDialog(Builder builder) {
        ...
        this.view.setBackgroundResource(builder.background != 0 ? builder.background : R.drawable.md_background);
    ...
    private void setDividerVisibility(boolean topVisible, boolean bottomVisible) {
        ...
        if (bottomVisible) {
            ...
            final int bottomMargin = getContext().getResources().getDimensionPixelSize(R.dimen.md_button_frame_vertical_padding);
            final int topMargin = getContext().getResources().getDimensionPixelSize(R.dimen.md_title_frame_margin_bottom);

            // The top and bottom margin used to be 0, but this looked weird.
            setVerticalMargins(view.findViewById(R.id.buttonStackedFrame), bottomMargin, bottomMargin);
            setVerticalMargins(view.findViewById(R.id.buttonDefaultFrame), topMargin, bottomMargin);
        } else {
            Resources r = getContext().getResources();
    ...
    private boolean invalidateActions() {
        ...
        if (mBuilder.positiveText != null) {
            ...
            setTypeface(positiveTextView, mBuilder.regularFont);
        ...
        if (mBuilder.neutralText != null) {
            ...
            setTypeface(neutralTextView, mBuilder.regularFont);
        ...
        if (mBuilder.negativeText != null) {
            ...
            setTypeface(negativeTextView, mBuilder.regularFont);
            ...
            if (!isStacked) {
                ...
                if (mBuilder.positiveText != null) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                        params.addRule(RelativeLayout.END_OF, R.id.buttonDefaultPositive);
                    } else {
    ...
    public static class Builder {
        ...
        public Builder accentColorRes(@ColorRes int colorRes) {
            accentColor(this.context.getResources().getColor(colorRes));
            return this;
        }

        public Builder accentColorAttr(@AttrRes int colorAttr) {
            accentColor(DialogUtils.resolveColor(this.context, colorAttr));
            return this;
        }
