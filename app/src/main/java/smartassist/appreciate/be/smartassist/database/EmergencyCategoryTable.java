 ...
 */
public class EmergencyCategoryTable
{
    public static final String TABLE_NAME = "emergency_categories";
    ...
    public static final String COLUMN_SHOW_TAB = "show_tab";
    ...
    public static final String COLUMN_SHOW_TAB_FULL = TABLE_NAME + "_" + COLUMN_SHOW_TAB;
    ...
    static
    {
        ...
        PROJECTION_MAP.put(TABLE_NAME + "." + COLUMN_SHOW_TAB, TABLE_NAME + "." + COLUMN_SHOW_TAB + " AS " + COLUMN_SHOW_TAB_FULL);
