...
import smartassist.appreciate.be.smartassist.fragments.EmergencyFragment;
...
public class EmergencyActivity extends BaseActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        textViewTitle.setText(R.string.module_emergency);
        ...
        this.getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.content_frame, new EmergencyFragment())
                .commit();
    }
    ...
    {
        return TrackHelper.SCREEN_EMERGENCY;
    }
}
